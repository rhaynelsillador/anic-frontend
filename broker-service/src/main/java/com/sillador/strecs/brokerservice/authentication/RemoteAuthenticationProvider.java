...
public class RemoteAuthenticationProvider implements AuthenticationProvider {
    ...
    public RemoteAuthenticationProvider(RemoteUserDetailsService userDetailsService) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        return new UsernamePasswordAuthenticationToken(user.getUsername(), user.getUsername(), user.getAuthorities());
    }
