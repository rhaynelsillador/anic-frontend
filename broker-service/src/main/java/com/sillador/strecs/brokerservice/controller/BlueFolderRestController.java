 ...
 */
@RestController
@RequestMapping("/bluefolder/api/v1")
@Order(3) // Lower priority than FileUploadController and BrokerRestController
public class BlueFolderRestController {

    private static final Logger logger = LoggerFactory.getLogger(BlueFolderRestController.class);
    private final BrokerService brokerService;

    public BlueFolderRestController(BrokerService brokerService) {
