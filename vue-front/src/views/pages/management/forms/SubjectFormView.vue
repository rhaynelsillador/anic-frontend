...
<template>
    <Dialog v-model:visible="isOpen" :style="{ width: '40%' }" header="Subject Details" :modal="true" @hide="hideDialog">
        ...
        <Fluid>
            <div class="flex flex-row md:flex-col gap-8">
                ...
                <div class="flex flex-wrap gap-2 w-full">
                    <label for="firstname2">Year Level</label>
                    <Select id="state" v-model="subjectInfo.yearLevel" :options="yearLevels" option-value="name" optionLabel="name" placeholder="Select One" class="w-full"></Select>
                </div>
