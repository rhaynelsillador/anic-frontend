...
<template>
    <div class="bg-surface-50 dark:bg-surface-650 flex items-center justify-center min-h-screen overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-650 py-20 px-8 sm:px-20 flex flex-col items-center"
                    ...
                    <div class="gap-3 flex flex-col items-center">
                        ...
                        <h1 class="text-surface-900 dark:text-surface-0 font-bold text-4xl lg:text-3xl mb-2">Access
                            Denied</h1>
                        <span class="text-muted-color mb-8">You do not have the necessary permisions. Please contact
                            admins.</span>
                        <img src="/demo/images/access/asset-access.svg" alt="Access denied" class="mb-8" width="50%" />
